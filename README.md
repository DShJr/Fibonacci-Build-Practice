...
**Описание:** Практический проект на C++ для закрепления основ программирования и освоения современных методов сборки. Программа вычисляет и выводит в консоль первые пять чисел Фибоначчи.
